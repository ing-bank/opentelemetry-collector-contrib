module github.com/open-telemetry/opentelemetry-collector-contrib/exporter/inmemorymetricexporter
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/exporter/inmemorymetricexporter => ./
